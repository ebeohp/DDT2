...
export default class Transition1 extends Phaser.Scene
{
    ...
    create()
    {
        this.add.bitmapText(150,40, "pixelFont", "Level 1 Stats", 30);
        this.decision = "";

        if(this.stars == 35 && this.trees == 7)
        {
    ...
    starStats()
    {
        this.add.bitmapText(150,100, "pixelFont", "Stars Collected: " + this.stars + "/35", 15);
    }
    timeStats()
    {
